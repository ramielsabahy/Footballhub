      ...
      <nav class="navbar navbar-default navbar-fixed-top menu">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index-register.html"><img src="{{ url('assets/images/logo3.png') }}" alt="logo" /></a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <li>
              {!! Form::open(array('action' => 'Auth\SocialNetworkLoginController@logout', 'data-parsley-validate' => '')) !!}
                {{Form::submit('Logout')}}
              {!! Form::close() !!}
              </li>
            </ul>
