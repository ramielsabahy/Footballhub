    ...
    <div class="row" style="margin-top: 150px">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Create Terms and Conditions</div>

                <div class="panel-body">
					{!! Form::open(array('action' => 'TermsAndConditionsController@setTermsAndConditions', 'method' => 'POST', 'data-parsley-validate' => '')) !!}
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="termsandconditions">Terms and Conditions</label>
                                <div class="col-md-10">
                                    {!! Form::textarea('termsandconditions', null, [
                                        'class'                         => 'form-control',
...
@section('scripts')
	...
	<script>
	    $('form').on('submit', function(e){
	          ...
	          var wrapper = {termsandconditions:content};
