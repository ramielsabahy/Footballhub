...
@section('addHeading')
    <a href="{{URL::route('createRefereeView')}}">New Referee</a>
@endsection
        ...
        columnDefs: [
           {
               "render": function (data, type, row) {
                    return '<a href="/hub/public/referees/editView/'+row['id']+'" title="Edit"><img src="{{URL::asset('assets/images/edit.png')}}" width="30px" /></a> | ' +
