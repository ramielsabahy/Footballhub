        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-color panel-primary">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => '/admins/edit','data-parsley-validate' => '', 'method' => 'POST')) !!}
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="field form-control" name="password" id="password" type="password" value="" placeholder="ADD NEW OR LEAVE EMPTY">
                                </div>
                            </div>
                            <div class="form-group">
