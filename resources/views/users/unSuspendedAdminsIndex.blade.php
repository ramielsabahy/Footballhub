...
@section('addHeading')
    <a href="{{URL::route('createAdminView')}}">New Admin</a>
@endsection
...
<script>
    ...
    function getUsers() {
        ...
        "ajax": {
                "url": "{{URL::route('allUnSuspendedAdmins')}}",
                "dataSrc": "",
        },
        columns: [
             { data: 'id' },
        ...
        columnDefs: [
           {
               ...
               "render": function (data, type, row) {
                    return '<a href="/cpanel/admins/editView/'+row['id']+'" title="Edit"><img src="{{URL::asset('assets/images/edit.png')}}" width="30px" /></a> | ' +
