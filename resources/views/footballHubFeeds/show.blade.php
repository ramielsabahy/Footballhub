        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-color panel-info">
                <div class="panel-heading" style="color: white">
                    <h3 style="color: white">Football Hub Feed #{{ $feed->id }}</h3>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            @if($feed->feed_type == 1)
                            <img src="{!! url('/') !!}/storage/football_hub_feeds/{{ $feed->thumbnail }}" class="thumbnail" style="width:100%;height:100%;"/>
                ...
                <div class="panel-footer">
                    ...
                    <hr/>
                    <a href="/cpanel/footballHubFeeds/editView/{{ $feed->id }}" title="Edit">
                        <img src="{{URL::asset('assets/images/edit.png')}}" width="30px" />
                    </a>
                    |
                    <a href="#" onclick="RemoveFootballHubFeed({{ $feed->id }}); return false; " title="Delete">
...
<script>
    ...
    function OnRequestCompleted(response) {
        ...
        window.location.replace(APP_URL+'/cpanel/footballHubFeeds/indexView');
    }
